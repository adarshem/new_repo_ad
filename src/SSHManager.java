...
public class SSHManager {
	...
	public static void main(String[] args) {
		...
		try {
			String command = "ls Build";
			String userName = "quickmobile";
			String password1 = "rvs@123";
			String connectionIP = "27.251.163.158";
			JSch jsch = new JSch();
			//JSch.setConfig("StrictHostKeyChecking", "no");
			
			SSHManager instance = new SSHManager(userName, password1, connectionIP, "");
